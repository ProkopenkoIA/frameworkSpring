package ru.gb.Lsn12Ex1.configuration;
...
public class IntegrationConfig {
    ...
    @Bean
    public MessageChannel testInputChanel(){
        return new DirectChannel();
    }
    ...
    public FileWritingMessageHandler messageHandler(){
        FileWritingMessageHandler handler = new FileWritingMessageHandler(new File("C:/Обучение/Java/SPRING/Lsn12Ex1"));
